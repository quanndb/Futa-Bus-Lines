...
public enum BadRequestError implements ResponseError {
    ...
    SCHEDULE_ALREADY_EXISTED(4000023, "Lịch trình đã tồn tại: ${0}"),
    ...
    FROM_MUST_BEFORE_TO(4000029, "Ngày kết thúc phải sau ngày bắt đầu: ${0}"),
    INVALID_DATE(4000030, "Lịch trình không hợp lệ: ${0}"),
